function contactList () {
	...
	$('.conversation-container').append(newPeople("","Suraj","12:04","hi","1","suraj"));
	$('.conversation-container').append(newPeople("","Mahesh ","12:04","Hello","1","mahesh"));
	$('.conversation-compose').hide();

}
socket.on('users', data => {
	$('.conversation-container').append(newPeople("",data.name,"12:04","hi","1",data.name));
});
